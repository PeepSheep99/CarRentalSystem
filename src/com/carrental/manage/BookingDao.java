...
public class BookingDao {
	...
	public static boolean createBooking(Booking booking) {
		...
		try {
			...
			pstm.setDate(1, java.sql.Date.valueOf(booking.getBookingStartDate()));
			pstm.setDate(2, java.sql.Date.valueOf(booking.getBookingEndDate()));
	...
	public static boolean viewBookings(int customerId) {
		try {
			...
			String query = "select b.\"customerId\",carId,carModel,carCostPerDay,b.\"bookingStartDate\",b.\"bookingEndDate\" from carInventory c inner join booking b on carId = b.\"bookedCarId\" where b.\"customerId\" = ?";
	...
	public static boolean deleteBooking(int bookedCarId, String bookingStartDate) {
		...
		try {
			...
			String query = "delete from booking b where b.\"bookedCarId\" = ? and b.\"bookingStartDate\" = ?";

			PreparedStatement pStatement = connect.prepareStatement(query);
			pStatement.setInt(1, bookedCarId);
			pStatement.setDate(2, java.sql.Date.valueOf(bookingStartDate));
	...
	public static int getTotalCost(int customerId) {
		...
		try {
			...
			String getBookedCarIdQuery = "select b.\"bookedCarId\" from booking b where b.\"customerId\" = ?";
			...
			String getDateDiffQuery = "select (b.\"bookingEndDate\"::date - b.\"bookingStartDate\"::date) as days from booking b where b.\"customerId\" = ?";
