	...
	public static void viewCarDetails() {
		...
		try {
			...
			if (resultSet.next() == false) {
				...
				// Print all details
				System.out.printf("%5s %10s %10s %10s %10s", "carId", "carType", "carCount", "carModel",
						"carCostPerDay");
				System.out.println();
				do {
					...
					System.out.format("%5d %10s %10s %10s %10s", carId, carType, carCount, carModel, carCostPerDay);
					System.out.println();
